...
- **Thành thạo Introduction to Kubernetes:**
  ...
  - Thực hành hiệu quả về điều phối container
...
- **Chuyên gia Amazon EKS CI/CD Pipeline:**
  ...
  - Thực hành hiệu quả về CI/CD trên Kubernetes
...
- **Chuyên gia CI/CD trên Amazon EKS:**
  ...
  - Thực hành hiệu quả về EKS CI/CD
