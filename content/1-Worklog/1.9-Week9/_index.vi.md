...
- **Thành thạo Introduction to Kubernetes:**
  ...
  - Thực hành hiệu quả cho điều phối container
...
- **Chuyên gia Amazon EKS CI/CD Pipeline:**
  ...
  - Thực hành hiệu quả cho CI/CD trên Kubernetes
...
- **Chuyên gia CI/CD trên Amazon EKS:**
  ...
  - Thực hành hiệu quả cho EKS CI/CD
...
- **Chuyên gia Red Hat OpenShift Service trên AWS (ROSA):**
  ...
  - Thực hành hiệu quả cho enterprise Kubernetes
