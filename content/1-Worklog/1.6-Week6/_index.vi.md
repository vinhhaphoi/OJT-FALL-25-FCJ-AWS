...
- **Thành thạo AWS Shield DDoS Protection:**

  - Hiểu tính năng AWS Shield Standard và Advanced
  - Cấu hình bảo vệ DDoS cho tài nguyên
  - Giám sát và phản hồi các sự kiện DDoS
  - Triển khai bảo vệ chi phí và SLA
  - Phân tích mẫu tấn công và số liệu

- **Tìm hiểu về AWS GuardDuty Threat Detection:**

  - Hiểu khả năng phát hiện mối đe dọa của GuardDuty
  - Cấu hình phát hiện và cảnh báo
  - Phân tích mối đe dọa và bất thường
  - Triển khai phản hồi tự động
  - Giám sát bảo mật tài khoản và tài nguyên

- **Tìm hiểu về Amazon Inspector Security Assessment:**

  - Hiểu mẫu đánh giá Inspector
  - Cấu hình đánh giá bảo mật
  - Phân tích lỗ hổng và phát hiện
  - Triển khai hành động khắc phục
  - Giám sát tình trạng bảo mật

- **Thành thạo AWS Trusted Advisor Optimization:**
  - Hiểu best practices của Trusted Advisor
...
- **Thành thạo EC2 Systems Manager Operations:**
  ...
  - Thành thạo khái niệm và khả năng Systems Manager
  - Thành công cấu hình quản lý instance
  - Triển khai chiến lược vá tự động
  - Thiết lập quản lý phiên bảo mật
  - Tạo automation runbooks cho vận hành
  - Cấu hình chính sách tuân thủ
  - Giám sát sức khỏe và trạng thái instance
  - Thực hành hiệu quả về quản lý fleet
...
- **Thành thạo Amazon Redshift Data Warehouse:**
  ...
  - Thực hành hiệu quả về thiết kế data warehouse
...
- **Thành thạo Amazon EMR Big Data Processing:**
  ...
  - Thực hành hiệu quả về xử lý big data
...
- **Thành thạo AWS Glue ETL Service:**
  ...
  - Thực hành hiệu quả về tích hợp dữ liệu
...
- **Thành thạo Amazon ElastiCache In-Memory Cache:**
  ...
  - Thực hành hiệu quả về cache optimization
...
- **Thành thạo Amazon SQS Message Queue:**
  ...
  - Thực hành hiệu quả về reliable messaging
...
- **Thành thạo Amazon Kinesis Data Streaming:**
  ...
  - Thực hành hiệu quả về stream processing

- **Thành thạo Amazon MSK Kafka Service:**

  - Thành thạo khái niệm MSK và kiến trúc Kafka
  - Thành công tạo và cấu hình MSK clusters
  - Triển khai Kafka topics và chiến lược phân vùng
  ...
  - Thực hành hiệu quả về vận hành Kafka

- **Thành thạo Amazon MQ Message Broker:**

  - Thành thạo khái niệm Amazon MQ và loại broker
  - Thành công triển khai ActiveMQ và RabbitMQ brokers
  - Cấu hình queues và topics cho messaging
