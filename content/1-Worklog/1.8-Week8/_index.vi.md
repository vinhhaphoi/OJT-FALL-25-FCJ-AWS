...
- **Thành thạo AWS Chatbot DevOps Notifications:**
  ...
  - Thực hành hiệu quả cho cộng tác DevOps
...
- **Thành thạo AWS AppConfig Configuration Management:**
  ...
  - Thực hành hiệu quả cho thay đổi cấu hình an toàn
...
- **Thành thạo Systems Manager Session Manager Security:**
  ...
  - Thực hành hiệu quả cho truy cập vận hành an toàn
...
- **Thành thạo AWS Data Pipeline Orchestration:**
  ...
  - Thực hành hiệu quả cho data pipelines đáng tin cậy
...
- **Thành thạo AWS Batch Computing:**
  ...
  - Thực hành hiệu quả cho batch computing có thể mở rộng
...
- **Thành thạo AWS Step Functions Workflow Orchestration:**
  ...
  - Thực hành hiệu quả cho thiết kế workflow
...
- **Thành thạo Amazon Rekognition Computer Vision:**
  ...
  - Thực hành hiệu quả cho ML-powered vision
...
- **Thành thạo Amazon Transcribe Speech-to-Text:**
  ...
  - Thực hành hiệu quả cho speech recognition
...
- **Thành thạo Triển khai Amazon Lightsail Containers:**
  ...
  - Thực hành hiệu quả cho container workloads đơn giản
...
- **Chuyên gia Kiến trúc Microservices với Docker và ECS:**
  ...
  - Thực hành hiệu quả cho kiến trúc cloud-native
...
- **Thành thạo AWS CDK Infrastructure as Code:**
  ...
  - Thực hành hiệu quả cho infrastructure as code
...
- **Chuyên gia Triển khai Spring Boot trên ECS Fargate:**
  ...
  - Thực hành hiệu quả cho Java microservices trên AWS
