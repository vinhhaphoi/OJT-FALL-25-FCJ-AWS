...
- **Thành thạo Triển khai Amazon Lightsail Containers:**
  ...
  - Áp dụng best practices cho container workloads đơn giản
...
- **Chuyên gia Kiến trúc Microservices với Docker và ECS:**
  ...
  - Áp dụng best practices cho kiến trúc cloud-native
...
- **Thành thạo AWS CDK Infrastructure as Code:**
  ...
  - Áp dụng best practices cho infrastructure as code
...
- **Chuyên gia Triển khai Spring Boot trên ECS Fargate:**
  ...
  - Áp dụng best practices cho Java microservices trên AWS
